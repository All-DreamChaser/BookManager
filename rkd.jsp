...
<form action="rk" method="post">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">请输入图书信息</h2>
      </div>
      <ul class="ulColumn2">
       <li>
        <span class="item_name" style="width:120px;">图书名称：</span>
        <input type="text" name="name" class="textbox textbox_225"  placeholder="图书名称..."/>
       ...
       <li>
        <span class="item_name" style="width:120px;">出版商：</span>
        <input type="text"  name="gy" class="textbox textbox_225" placeholder="出版商..."/>
       </li>
       <li>
